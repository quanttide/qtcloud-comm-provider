...
class Wallet(models.Model):
    ...
    type = models.CharField(choices=WalletTypeChoices.choices, verbose_name='钱包类型')
...
class IndividualProfile(models.Model):
    ...
    """
    id = models.UUIDField(primary_key=True, editable=False, default=uuid.uuid4)
    wallet = models.OneToOneField(Wallet, related_name='balances', on_delete=models.CASCADE, verbose_name='关联钱包')
