# Generated by Django 3.2.10 on 2022-08-04 06:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price', to='products.product', verbose_name='课程')),
            ],
            options={
                'verbose_name': '价格',
                'ordering': ['created_at'],
